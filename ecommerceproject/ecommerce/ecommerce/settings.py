...
SECRET_KEY = 'django-insecure-!&ei6xx%+9rprfkw#lbvem1tx67vtw%%)4z7*06j0mv2gy+_@k'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles', 'shop', 'cart', 'search','corsheaders',  'social_django',
]
...
# credentials for facebook social auth
SOCIAL_AUTH_FACEBOOK_KEY = '884695152998951'
SOCIAL_AUTH_FACEBOOK_SECRET = '9e20432333fd7887c372cc7ad3faf8d1'
SOCIAL_AUTH_FACEBOOK_SCOPE = ['email']  # Additional permissions you need
